...
import { getMesReservations } from "../../shared/services/AdminService";
  ...
  return (
    <div className="reservations-container">
      ...
      <div className="reservations-topbar">
        <div>
          <h2 className="reservations-logo">FormaCamp Academy</h2>

          <p className="reservations-subtitle">My Reservations</p>
        </div>
      ...
      <div className="reservations-list">
        {reservations.map((reservation) => (
          <div key={reservation.id} className="reservation-card">
            ...
            <h2>{reservation.atelier?.titre}</h2>

            <p>
              <strong>Date :</strong> {reservation.atelier?.date_debut}
            </p>

            <div className="status-box">
              <strong>Statut :</strong>

              <span className={reservation.statut}>{reservation.statut}</span>
            </div>
