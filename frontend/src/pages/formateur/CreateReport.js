          ...
          <div className="section">
            ...
            <div className="row">
              <div className="col">
                ...
                {errors.moyenne_exercices && (
                  <small className="error">{errors.moyenne_exercices[0]}</small>
                )}
              </div>
              ...
              <div className="col">
                ...
                {errors.moyenne_examen && (
                  <small className="error">{errors.moyenne_examen[0]}</small>
                )}
              </div>
            </div>
